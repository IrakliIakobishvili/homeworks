...
},{"react":"../node_modules/react/index.js"}],"components/user/Comment.js":[function(require,module,exports) {
"use strict";
...
var Comment = function Comment(props) {
  return _react.default.createElement("div", {
    ...
    className: "title"
  }, "Post ID: "), props.postID), _react.default.createElement("h1", null, _react.default.createElement("span", {
    className: "title"
  }, "Comment ID: "), props.id), _react.default.createElement("h1", null, _react.default.createElement("span", {
    className: "title"
  }, "Name: "), " ", props.name), _react.default.createElement("h1", null, _react.default.createElement("span", {
    className: "title"
  }, "Email: "), " ", props.email), _react.default.createElement("div", null, _react.default.createElement("span", {
    className: "title"
  }, "Message: "), " ", props.body));
};

exports.Comment = Comment;
},{"react":"../node_modules/react/index.js"}],"components/user/Post.js":[function(require,module,exports) {
"use strict";
...
var Post = function Post(props) {
  return _react.default.createElement("div", {
    ...
    onClick: function onClick() {
      return props.loadComment(props.id);
    }
  }, _react.default.createElement("h1", null, _react.default.createElement("span", {
    className: "title"
  }, "User ID: "), props.userID), _react.default.createElement("h1", null, _react.default.createElement("span", {
    className: "title"
  }, "Post ID: "), props.id), _react.default.createElement("h1", null, _react.default.createElement("span", {
    className: "title"
  }, "Title: "), " ", props.title), _react.default.createElement("div", null, _react.default.createElement("span", {
    className: "title"
  }, "Message: "), " ", props.body), props.comments.map(function (comment) {
    return props.id === comment.postId ? _react.default.createElement(_Comment.Comment, {
      key: comment.id,
      id: comment.id,
      postID: props.id,
      name: comment.name,
...
exports.Post = Post;
},{"react":"../node_modules/react/index.js","./Comment":"components/user/Comment.js"}],"components/user/User.js":[function(require,module,exports) {
"use strict";
...
var User = function User(props) {
  return _react.default.createElement("div", {
    className: "user",
    onClick: function onClick() {
      return props.loadPost(props.user.id);
    }
  }, _react.default.createElement("h1", null, _react.default.createElement("span", {
    className: "title"
  }, "User ID: "), " ", props.user.id), _react.default.createElement("h1", null, _react.default.createElement("span", {
    className: "title"
    ...
    return props.user.id === post.userId ? _react.default.createElement(_Post.Post, {
      key: post.id,
      id: post.id,
      userID: post.userId,
      title: post.title,
      body: post.body,
      loadComment: props.loadComment,
...
exports.User = User;
},{"react":"../node_modules/react/index.js","./Company":"components/user/Company.js","./Address":"components/user/Address.js","./Post":"components/user/Post.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.loadPost = _this.loadPost.bind(_assertThisInitialized(_this));
  ...
  _createClass(App, [{
    ...
    key: "loadComment",
    value: function loadComment(id) {
      var _this4 = this;

      this.fetchRequest(commentUrl, function (data) {
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        return _react.default.createElement(_User.User, {
          loadPost: _this5.loadPost,
          key: user.id,
          user: user,
          posts: _this5.state.posts,
          loadComment: _this5.loadComment,
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "12524" + '/');
